...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            cloud::cmd::cloud_connected_accounts,
            cloud::cmd::cloud_disconnect_account,
            cloud::cmd::cloud_sign_out,
            cloud::t2t_cmd::t2t_list_relationships,
            ...
            cloud::circles_cmd::circles_create,
            cloud::circles_cmd::circles_list,
            cloud::circles_cmd::circles_join,
            cloud::circles_cmd::circles_leave,
            ...
            cloud::cmd::cloud_workflow_schedules,
            cloud::cmd::cloud_workflow_create_schedule,
            ...
            conversation_cmd::delete_conversation,
